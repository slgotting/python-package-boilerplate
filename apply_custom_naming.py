...
pkg_name = input('Enter your desired package name (separated by hyphens (-)): ')
script_name = input('Enter your desired cli tool name (once again, separated by hyphens), leave blank if no associated cli tool: ')
...
if script_name:
    ...
    # set script to read 
    os.system(f"cd scripts && sed -i 's/package_boilerplate/{pkg_name_underscores}/g' {script_name}")
else:
    # delete scripts line 
    os.system("sed -i '/scripts=/ d' setup2.py")
